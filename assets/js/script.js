...
async function getAboutGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/kauaalves7163-collab');
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                <h2>Sobre mim</h2>
                <p>
                    Olá! Sou estudante de Bacharelado em Ciências e Tecnologia na UFABC e estou me especializando como Desenvolvedor Full Stack Java através da Generation Brasil. Movido pelo desafio de solucionar problemas técnicos complexos, tenho como foco o desenvolvimento de softwares estruturados, eficientes e escaláveis, utilizando metodologias ágeis como SCRUM para entregas de alto valor.
                </p>

                <p>
                    Minha pilha tecnológica principal envolve o ecossistema Java e Spring Boot, além de experiência com Python, criação de APIs RESTful, persistência de dados com MySQL e controle de versão via Git/GitHub. Um exemplo prático da minha experiência é o desenvolvimento de uma API RESTful para e-commerce (Loja de Games), onde apliquei arquitetura em camadas, Spring Data JPA e Jakarta Bean Validation para garantir a integridade do sistema. Somado a isso, minha bagagem com técnicas de troubleshooting em manutenção de hardware e software me deu um forte senso analítico e de diagnóstico rápido para resolução de bugs.
                </p>
...
async function getProjectsGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/kauaalves7163-collab/repos?sort=updated&per_page=6');
